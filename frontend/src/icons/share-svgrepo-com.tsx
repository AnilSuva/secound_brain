...
function ShareIcon({ width = 24, height = 24, className, fill = 'currentColor' }: ShareProps) {
    return (
        <svg width={width} height={height} viewBox="-1 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" className={className}>
            <title>share</title>
            <desc>Created with Sketch Beta.</desc>
            <g id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                <g id="Icon-Set" transform="translate(-312.000000, -726.000000)" fill={fill}>
                    <path
